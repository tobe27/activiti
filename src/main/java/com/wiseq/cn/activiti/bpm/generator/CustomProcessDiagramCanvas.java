...
public class CustomProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
    ...
    //font
    protected String activityFontName = "楷体";
    protected String labelFontName = "楷体";
    protected String annotationFontName = "楷体";
    ...
    public BufferedImage generateBufferedImage(String imageType) {
        ...
        minX = (minX <= 20) ? 20 : minX;
        minY = (minY <= 20) ? 20 : minY;
    ...
    public void initialize(String imageType) {  
        ...
        Font font = new Font(activityFontName, Font.BOLD, 12);
        g.setFont(font);   
        this.fontMetrics = g.getFontMetrics();      
        
        LABEL_FONT = new Font(labelFontName, Font.ITALIC, 10);
        ANNOTATION_FONT = new Font(annotationFontName, Font.PLAIN, 12);
        //优化加载速度
        if(flag) {
            return;
        }
